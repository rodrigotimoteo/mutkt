...
/**
 * A Java/Kotlin class name. Dotted form (e.g. `com.example.Foo`) is
 * the canonical representation used by [com.github.rodrigotimoteo.mutation.model.Mutation],
 * the engine, and the reports. Slashed form (`com/example/Foo`) is
 * the JVM-internal form used by ASM and the classloader.
 */
typealias ClassName = String

/**
 * A regex pattern matched against a class name to decide whether
 * the class should be included in or excluded from mutation. See
...
/**
 * Unique identifier for a single mutation point. Format is
