...
plugins {
    ...
    id("io.github.rodrigotimoteo.mutation-kotlin") version "0.3.3"
}
```
...
```kotlin
dependencies {
    testImplementation("io.github.rodrigotimoteo:mutation-test-runner:0.3.3")
}
...
buildscript {
    ...
    dependencies {
        classpath("io.github.rodrigotimoteo:mutation-gradle-plugin:0.3.3")
    }
}
